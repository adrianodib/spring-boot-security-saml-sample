package br.com.assesso.dcsecurity.saml.security;

import static br.com.assesso.dcsecurity.saml.utils.JdbcUtils.PERMISSOES_POR_GRUPO;
import static br.com.assesso.dcsecurity.saml.utils.JdbcUtils.PERMISSOES_POR_USUARIO;
import static br.com.assesso.dcsecurity.saml.utils.JdbcUtils.USUARIO_POR_LOGIN;
...
public class DcUserDetailsService implements UserDetailsService {
	...
	private static final Logger logger = Logger.getLogger(DcUserDetailsService.class.getSimpleName());
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			DcUserDetails userDetails = buscarUsuario(connection, login);
	...
	public DcUserDetails buscarUsuario(Connection connection, String login) throws SQLException {
		...
		return new DcUserDetails(nome, login, password, ativo);
	}
